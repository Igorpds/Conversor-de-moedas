...
public class Conversor {
	...
	public static void main(String[] args) {
		...
		if (escolha == 0) { // conversor de moedas
			...
			double valor = Double.parseDouble(JOptionPane.showInputDialog(null, "Digite o valor a ser convertido"));
			...
			double valor = Double
					.parseDouble(JOptionPane.showInputDialog(null, "Digite a temperatura a ser convertida: "));
			...
			case "Celsius para Fahrenheit":
				...
				JOptionPane.showMessageDialog(null,  "A temperatura convertida é : " + String.format("%.2f", resultado));
				break;
